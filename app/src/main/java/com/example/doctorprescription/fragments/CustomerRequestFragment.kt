...
import com.example.doctorprescription.adapters.CustomerRequestsAdapter
...
import com.example.doctorprescription.databinding.FragmentCustomerRequestBinding
            ...
            for (snapshot in snapshot!!.documentChanges) {
                ...
                when (snapshot.type) {
                    DocumentChange.Type.ADDED -> {
                        ...
                        Log.e("", "userModelList ${prescriptionModelList.size}")
